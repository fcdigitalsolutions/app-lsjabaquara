...
const CadastroEnderec = () => {
  ...
  return (
    <Box sx={{ padding: '10px', color: 'rgb(0, 7, 61)', backgroundColor: 'rgb(255,255,255)' }}>
      <h2 style={{ fontSize: '1.4rem', marginTop: '40px' }}>Cadastro de Endereços/Mapas</h2> {/* Espaço maior acima do título */}
...
export default CadastroEnderec;
