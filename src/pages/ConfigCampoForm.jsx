...
const ConfigCampoForm = () => {
  ...
  return (
    <Box sx={{ padding: '16px', backgroundColor: 'rgb(255,255,255)', color: '#202038' }}>
      <h2 style={{ fontSize: '1.6rem', marginBottom: '16px' }}>Configurações de campo</h2>
      <Box sx={{ backgroundColor: 'rgb(255, 255, 255)', borderRadius: '16px' }}>
        <Box sx={{ backgroundColor: 'rgb(255, 255, 255)', borderRadius: '16px' }}>
          <Box>
            <Box sx={{ marginTop: '40px' }}></Box>

            <h4 style={{ fontSize: '1.2rem', marginBottom: '16px', color: "#5C3317" }}>Estrutura de Campo Semanal</h4>
          ...
          <Box>
            ...
            <h4 style={{ fontSize: '1.2rem', marginBottom: '16px', color: "#00009C" }}>Estrutura de Carrinho Semanal</h4>
            <TableContainer component={Paper} sx={{ marginTop: '10px' }}>
              <Table>
                <TableHead>
                  <TableRow>
