...
const RastreaForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editRow) {
      try {
        await axios.put(`http://127.0.0.1:5000/rastrear/${editRow.id}`, { cod_congreg,data_inicio,data_fim,cod_status});
      ...
      try {
        const response = await axios.post('http://127.0.0.1:5000/rastrear', { cod_congreg,data_inclu,data_inicio,data_fim,num_enderec,num_endconcl,cod_status });
